...
namespace demo
{
  ...
  void CreateObject(const FunctionCallbackInfo<Value> &args)
  {
    ...
    obj->Set(context, String::NewFromUtf8(isolate, "Name").ToLocalChecked(),
             inputObj->Get(context, String::NewFromUtf8(isolate, "name")
                                        .ToLocalChecked())
                 .ToLocalChecked())
        .FromJust();

    obj->Set(context, String::NewFromUtf8(isolate, "CompleteName").ToLocalChecked(),
             inputObj->Get(context, String::NewFromUtf8(isolate, "completeName")
                                        .ToLocalChecked())
                 .ToLocalChecked())
        .FromJust();

    obj->Set(context, String::NewFromUtf8(isolate, "Age").ToLocalChecked(),
             inputObj->Get(context, String::NewFromUtf8(isolate, "age")
                                        .ToLocalChecked())
                 .ToLocalChecked())
        .FromJust();
